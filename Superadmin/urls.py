...
from .views import SettingView,AddCategory,DeleteService, EditService,AddService,SuperadminAppointments,Newappointment
...
urlpatterns = [
    ...
    path("new-appointment/",Newappointment,name="superadmin-newappointments"),
    ]